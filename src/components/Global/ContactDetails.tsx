	...
	return (
		<section className='px-4 py-3 container mx-auto' id='contact'>
			...
			<div className='w-full gap-5 my-10 text-center'>
				...
				<Link href='mailto:jdamner@me.com' className="block bg-white dark:bg-slate-800 border-2 px-3 py-2 rounded-sm font-bold border-solid border-slate-900 hover:bg-slate-100 dark:hover:bg-slate-700" onMouseEnter={enableMouseOver} onMouseLeave={disableMouseOver}>
