...
export default function Header(
  ...
  return (
    <section
      id="header"
      className="bg-slate-200 dark:bg-slate-800 text-slate-900 dark:text-slate-300 py-10"
      {...rest}
    >
      <div className="container mx-auto text-center py-5 px-3 md:px-0 flex flex-col">
        <h1 className="font-sans text-5xl md:text-9xl font-black uppercase mb-5 order-2">
          {title}
        </h1>
        {subtitle && (
          <h2 className={subtitleClasses.join(" ")}>
            <ExpandingLine />
